...
Penyelesaian: Mengabaikan pesan error tersebut karena tidak memengaruhi program, lalu menjalankan ulang instruksi pemanggilan file virtual secara bersih melalui perintah cat /workspace/mnt/tujuan.txt.                    len--;
                }
                strcat(coord_buffer, coord_val);
                break;
            }
